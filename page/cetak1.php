...

{
...

    {
        ...
        $this->Cell(45, 7, 'BEASISWA', 1, 0, 'C');
        $this->Cell(40, 7, 'NILAI', 1, 0, 'C');
        ...
        $data = mysqli_query($connection, "SELECT b.nama AS beasiswa, a.nim, a.nilai, a.tahun, c.nama FROM hasil a JOIN beasiswa b USING(kd_beasiswa) JOIN mahasiswa c ON a.nim=c.nim");
        while ($d = mysqli_fetch_array($data)) {
            $this->Cell(10, 6, '', 0, 1);
            $this->Cell(10, 6, $no++, 1, 0, 'C');
            $this->Cell(20, 6, $d['nim'], 1, 0);
            $this->Cell(45, 6, $d['nama'], 1, 0);
            $this->Cell(45, 6, $d['beasiswa'], 1, 0);
            $this->Cell(40, 6, $d['nilai'], 1, 0);
            $this->Cell(25, 6, $d['tahun'], 1, 0);
        }
...
$pdf->garis();
$pdf->jdl('Data Pendaftar Keseluruhan');
$pdf->tbl();
$teks_a ='';
